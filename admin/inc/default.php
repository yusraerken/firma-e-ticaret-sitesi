...
<div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">ADMİN PANELİ</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                       ...
                       $kontrol = $query->rowcount();
                        ...
                        if($kontrol){
                          ...
                          echo '<li><div style="margin:5px;padding:10px" class="alert alert-warning">hiç mesajınız bulunmuyor...</div></li>';   
                       ...
                       ?>
                        ...
                        <li>
                            <a class="text-center" href="?do=mesajlar">
                                <strong>tum mesajları goruntule</strong>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="/admin/?do=cikis"><i class="fa fa-sign-out fa-fw"></i> cıkıs</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="?do=mesajlar"><i class="fa fa-table fa-fw"></i> mesajlar</a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/firma/admin/?do=ayarlar">ayarlar</a>
                                </li>
                                 <li>
                                    <a href="/firma//admin/?do=iletisim">iletisim</a>
                                </li>
